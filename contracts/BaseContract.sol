...
contract BaseContract {
    ...
    function getTotalBets() public view returns (uint256[11]) {
    ...
    function getVoteBalances() public view returns (uint256[11]) {
    ...
    function getTotalVotes() public view returns (uint256[11]) {
