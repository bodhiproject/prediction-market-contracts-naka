...
contract OracleFactory is IOracleFactory {
    ...
    function createCentralizedOracle(
        ...
        returns (address)
    {
        bytes32 hash = getCentralizedOracleHash(
            _eventAddress, _numOfResults, _oracle, _bettingStartTime, _bettingEndTime, _resultSettingStartTime, 
        ...
        emit CentralizedOracleCreated(
            version, address(cOracle), _eventAddress, _numOfResults, _oracle, _bettingStartTime, _bettingEndTime,
    ...
    function createDecentralizedOracle(
        ...
        returns (address)
    {
        bytes32 hash = getDecentralizedOracleHash(
            _eventAddress, _numOfResults, _lastResultIndex, _arbitrationEndTime, _consensusThreshold
        );
        ...
        emit DecentralizedOracleCreated(
            version, address(dOracle), _eventAddress, _numOfResults, _lastResultIndex, _arbitrationEndTime,
            _consensusThreshold
        );
